                   ...
                   {posts?.length>0 && <div className='md:max-w-[40rem] w-[100%] border-green-200 border-2 m-auto text-center'>
                        {
                            ...
                            return   ( <div className=''>
                                    ...
                                    <PostCard name={post.name} title={post.title} content={post.content} likes={post.likes} comments={post.comments} image={post.fileUrl} uid={post.uniqueId} fun={fetchPosts}  date={date}/>
                                </div>)
                            })
                        }
                    </div>}
