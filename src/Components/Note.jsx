...
function Note() {
  ...
  return (
    <>
  {visible && <div className='bg-[#18366A] h-[28rem] md:h-[17rem] p-4 md:p-8 my-4 rounded-lg border-4 border-red-500 border-opacity-50 relative'>
    <div className='border-4 border-green-500 border-opacity-50 rounded-lg p-4 md:p-8'>
      ...
      <p className='text-white font-bold  h-[100%] font-serif'>
