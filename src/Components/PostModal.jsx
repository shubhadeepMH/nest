...
function PostModal({uid,togglePostModal}) {
  ...
  return (
    ...
    <div  className='text-white ml-4 '>
        ...
        <div className='p-3 '>
            {
                postData?.fileUrl && (postData?.fileUrl.includes('png') ||  postData?.fileUrl.includes('jpeg') ||  postData?.fileUrl.includes("jpg")) && <img className='h-[20rem] w-[30rem] m-auto text-center rounded-lg z-0' src={postData.fileUrl} />
